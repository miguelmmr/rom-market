    ...
    <div class="container">
      ...
      <section class="container__testimonials">
        ...
        <p class="testimonial__txt">En el juego, el jugador o usuario controla una larga y delgada criatura, semejante a
          una serpiente, que vaga alrededor de un plano delimitado, recogiendo alimentos (o algún otro elemento),
          tratando de evitar golpearse contra su propia cola o las "paredes" que rodean el área de juego. Cada vez que
          la serpiente se come un pedazo de comida, la cola crece más, provocando que aumente la dificultad del juego.
          El usuario controla la dirección de la cabeza de la serpiente (arriba, abajo, izquierda o derecha) y el cuerpo
          de la serpiente la sigue. Además, el jugador no puede detener el movimiento de la serpiente, mientras que el
          juego está en marcha.</p>
      </section>
      ...
      <section class="container-tips">
        <div class="tip">
          ...
          <p class="tip__txt">Spider-Man, traducido en ocasiones como El Hombre Araña,11​12​ es un personaje creado por
            los estadounidenses Stan Lee y Steve Ditko,13​14​ e introducido en el cómic Amazing Fantasy n.° 15,
            publicado por Marvel Comics en agosto de 1962.15​ Se trata de un superhéroe que emplea sus habilidades
            sobrehumanas, reminiscentes de una araña, para combatir a otros supervillanos que persiguen fines
            siniestros.</p>
        ...
        <div class="tip">
          ...
          <p class="tip__txt">Pokémon Edición Rubí y Pokémon Edición Zafiro (en inglés: Pokémon Ruby Version & Sapphire
            Version), conocidos en Japón como Pocket Monsters Ruby & Sapphire (ポケットモンスター ルビー & サファイア Poketto Monsutā
            Rubī & Safaia?), son dos videojuegos del género RPG pertenecientes a la tercera generación de la saga
            Pokémon, y los primeros en su tipo lanzados para la consola portátil Game Boy Advance de Nintendo. Ambos,
            marcan el principio de la tercera generación de la serie, y se ambientan en una nueva región denominada
            Hoenn.</p>
          <a href="" class="btn-shop">COMPRA AHORA</a>
        </div>
        <div class="tip">
          ...
          <p class="tip__txt">Super Mario Bros. fue el juego que popularizó al personaje de Mario,4​ convirtiéndolo en
            el ícono principal de Nintendo, y uno de los personajes más reconocidos de los videojuegos, así como su
            hermano menor Luigi. Además, presentó por primera vez a la Princesa Peach Toadstool, Toad, Bowser, entre
            otros personajes. Este juego es considerado el primer videojuego de plataformas de desplazamiento lateral de
            Nintendo y se ha convertido en un hito debido a la trascendencia de su diseño y papel en la industria de los
            videojuegos. </p>
          <a href="" class="btn-shop">COMPRA AHORA</a>
        </div>
      </section>
